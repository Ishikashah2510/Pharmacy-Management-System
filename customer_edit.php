...
<html>
<head>
	<title>Patient details Edit</title>
	<style type="text/css">
		a{
			font-size: 20px;
...
<br>
<center>
<form action="customer_check.php" method="post">
<h1> Please enter patient id for whom you would like to update details : </h1><input type="number" name="pid" required maxlength="6">
<h1>Enter which detail to update : </h1>
<input type="radio" name="add">Address
